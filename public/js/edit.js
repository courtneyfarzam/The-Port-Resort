...
document.querySelector('edit-about-form').addEventListener('submit', editPost)
document.querySelector('edit-education-form').addEventListener('submit', editPost)
document.querySelector('edit-work-form').addEventListener('submit', editPost)
document.querySelector('edit-project-form').addEventListener('submit', editPost)